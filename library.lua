    ...
    if (#args > 0 and typeof(args[1]) == 'table') then
        ...
        if (typeof(theme) == 'string') then
            ...
            elseif (theme == 'watermelon') then  -- legacy red-aqua
                ...
                elseif (theme == 'midnight') then          -- deep dark + electric blue/purple
    theme = {
        Primary = Color3.fromRGB(100, 180, 255);
        Secondary = Color3.fromRGB(180, 120, 255);
        
        Window1 = Color3.fromRGB(8, 8, 18);
        Window2 = Color3.fromRGB(4, 4, 12);
        Window3 = Color3.fromRGB(6, 6, 15);
        
        Button1 = Color3.fromRGB(12, 12, 24);
        Button2 = Color3.fromRGB(16, 16, 32);
        Button3 = Color3.fromRGB(22, 22, 44);
        Button4 = Color3.fromRGB(26, 26, 52);
        
        Stroke = Color3.fromRGB(35, 35, 60);
        StrokeHover = Color3.fromRGB(80, 140, 255);
        
        Inset1 = Color3.fromRGB(3, 3, 10);
        Inset2 = Color3.fromRGB(1, 1, 6);
        Inset3 = Color3.fromRGB(2, 2, 8);
        
        TextPrimary = Color3.fromRGB(235, 235, 245);
        TextStroke = Color3.fromRGB(0, 0, 0);
        TextDim = Color3.fromRGB(140, 140, 170);
        
        ControlGradient1 = Color3.fromRGB(220, 220, 255);
        ControlGradient2 = Color3.fromRGB(160, 160, 220);
    }

elseif (theme == 'emerald') then           -- rich emerald green + dark mode
    theme = {
        Primary = Color3.fromRGB(46, 204, 113);
        Secondary = Color3.fromRGB(39, 174, 96);
        
        Window1 = Color3.fromRGB(16, 24, 22);
        Window2 = Color3.fromRGB(10, 16, 14);
        Window3 = Color3.fromRGB(13, 20, 18);
        
        Button1 = Color3.fromRGB(20, 32, 28);
        Button2 = Color3.fromRGB(24, 38, 34);
        Button3 = Color3.fromRGB(32, 50, 44);
        Button4 = Color3.fromRGB(38, 60, 52);
        
        Stroke = Color3.fromRGB(50, 80, 70);
        StrokeHover = Color3.fromRGB(80, 200, 130);
        
        Inset1 = Color3.fromRGB(8, 16, 14);
        Inset2 = Color3.fromRGB(4, 10, 8);
        Inset3 = Color3.fromRGB(6, 13, 11);
        
        TextPrimary = Color3.fromRGB(245, 245, 245);
        TextStroke = Color3.fromRGB(0, 0, 0);
        TextDim = Color3.fromRGB(160, 190, 175);
        
        ControlGradient1 = Color3.fromRGB(220, 255, 230);
        ControlGradient2 = Color3.fromRGB(160, 220, 190);
    }

elseif (theme == 'coral') then             -- vibrant coral/pink + dark warm bg
    theme = {
        Primary = Color3.fromRGB(255, 99, 132);
        Secondary = Color3.fromRGB(255, 159, 64);
        
        Window1 = Color3.fromRGB(28, 18, 22);
        Window2 = Color3.fromRGB(20, 12, 16);
        Window3 = Color3.fromRGB(24, 15, 19);
        
        Button1 = Color3.fromRGB(34, 24, 28);
        Button2 = Color3.fromRGB(40, 28, 34);
        Button3 = Color3.fromRGB(52, 36, 44);
        Button4 = Color3.fromRGB(60, 42, 50);
        
        Stroke = Color3.fromRGB(70, 50, 60);
        StrokeHover = Color3.fromRGB(255, 140, 170);
        
        Inset1 = Color3.fromRGB(16, 10, 14);
        Inset2 = Color3.fromRGB(8, 6, 8);
        Inset3 = Color3.fromRGB(12, 8, 11);
        
        TextPrimary = Color3.fromRGB(255, 245, 245);
        TextStroke = Color3.fromRGB(0, 0, 0);
        TextDim = Color3.fromRGB(200, 170, 180);
        
        ControlGradient1 = Color3.fromRGB(255, 220, 230);
        ControlGradient2 = Color3.fromRGB(220, 180, 200);
    }

elseif (theme == 'void') then              -- pure black + neon accents (cyberpunk-ish)
    theme = {
        Primary = Color3.fromRGB(0, 255, 255);     -- cyan
        Secondary = Color3.fromRGB(255, 0, 255);   -- magenta
        
        Window1 = Color3.fromRGB(4, 4, 6);
        Window2 = Color3.fromRGB(2, 2, 3);
        Window3 = Color3.fromRGB(3, 3, 4);
        
        Button1 = Color3.fromRGB(8, 8, 12);
        Button2 = Color3.fromRGB(12, 12, 18);
        Button3 = Color3.fromRGB(18, 18, 26);
        Button4 = Color3.fromRGB(22, 22, 32);
        
        Stroke = Color3.fromRGB(18, 18, 28);
        StrokeHover = Color3.fromRGB(0, 220, 220);
        
        Inset1 = Color3.fromRGB(2, 2, 4);
        Inset2 = Color3.fromRGB(0, 0, 1);
        Inset3 = Color3.fromRGB(1, 1, 2);
        
        TextPrimary = Color3.fromRGB(240, 240, 255);
        TextStroke = Color3.fromRGB(0, 0, 0);
        TextDim = Color3.fromRGB(120, 120, 140);
        
        ControlGradient1 = Color3.fromRGB(180, 255, 255);
        ControlGradient2 = Color3.fromRGB(120, 180, 255);
    }

elseif (theme == 'lavender') then          -- soft purple/lavender aesthetic
    theme = {
        Primary = Color3.fromRGB(173, 127, 255);
        Secondary = Color3.fromRGB(140, 90, 230);
        
        Window1 = Color3.fromRGB(24, 22, 34);
        Window2 = Color3.fromRGB(18, 16, 26);
        Window3 = Color3.fromRGB(21, 19, 30);
        
        Button1 = Color3.fromRGB(30, 28, 42);
        Button2 = Color3.fromRGB(36, 34, 50);
        Button3 = Color3.fromRGB(46, 42, 64);
        Button4 = Color3.fromRGB(54, 50, 74);
        
        Stroke = Color3.fromRGB(60, 55, 85);
        StrokeHover = Color3.fromRGB(160, 120, 255);
        
        Inset1 = Color3.fromRGB(16, 14, 26);
        Inset2 = Color3.fromRGB(10, 8, 18);
        Inset3 = Color3.fromRGB(13, 11, 22);
        
        TextPrimary = Color3.fromRGB(245, 240, 255);
        TextStroke = Color3.fromRGB(0, 0, 0);
        TextDim = Color3.fromRGB(170, 160, 200);
        
        ControlGradient1 = Color3.fromRGB(230, 210, 255);
        ControlGradient2 = Color3.fromRGB(190, 170, 230);
    }
            else
                theme = nil
            end
...
local loading = {} do 
    ...
    local barBackground = Instance.new('Frame') do
        barBackground.AnchorPoint = Vector2.new(0.5, 0)
        barBackground.BackgroundColor3 = theme.Window3
        barBackground.BorderColor3 = theme.Inset3
    ...
    local barFill = Instance.new('Frame') do
    ...
    local statusText = Instance.new('TextLabel') do
        ...
        statusText.TextXAlignment = 'Center'
        statusText.TextYAlignment = 'Center'
    ...
    instances.barFill = barFill
    instances.statusText = statusText
    loading.instances = instances
end
...
function loading.start()
    ...
    local overlay = loading.instances.overlay
...
function loading.stop()
    ...
    task.spawn(function()
        ...
        local d = overlay:GetDescendants()
        table.insert(d, overlay)
        ...
        animCon = renderService.RenderStepped:Connect(function(dt)
            ...
            for i = 1, #backgroundTransparency do
                local obj = backgroundTransparency[i]
                if obj.BackgroundTransparency < 1 then
                    obj.BackgroundTransparency = math.min(1, obj.BackgroundTransparency + dt)
                end
            end
            for i = 1, #textTransparency do
                local obj = textTransparency[i]
                if obj.TextTransparency < 1 then
                    obj.TextTransparency = math.min(1, obj.TextTransparency + dt)
                end
            end
        end)
...
-- start loading animation immediately; external scripts can hide it once ready
loading.start()
...
do
    ...
    -- expose loading controls so external scripts can manage the splash if needed
    ui.showLoading = function()
        if (loading and loading.start) then
            loading.start()
        end
    end

    ui.hideLoading = function()
        if (loading and loading.stop) then
            loading.stop()
        end
    end
    ...
    ui.newWindow = function(settings) 
        ...
        -- hide loading splash as soon as a window is created
        if (loading and loading.active) then
            loading.stop()
        end
